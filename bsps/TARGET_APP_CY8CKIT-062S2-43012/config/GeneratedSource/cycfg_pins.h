...
#endif //defined (CY_USING_HAL)
#define CYBSP_A6_ENABLED 1U
#define CYBSP_J2_13_ENABLED CYBSP_A6_ENABLED
#define CYBSP_POT_ENABLED CYBSP_A6_ENABLED
#define CYBSP_A6_PORT GPIO_PRT10
#define CYBSP_J2_13_PORT CYBSP_A6_PORT
#define CYBSP_POT_PORT CYBSP_A6_PORT
#define CYBSP_A6_PORT_NUM 10U
#define CYBSP_J2_13_PORT_NUM CYBSP_A6_PORT_NUM
#define CYBSP_POT_PORT_NUM CYBSP_A6_PORT_NUM
#define CYBSP_A6_PIN 6U
#define CYBSP_J2_13_PIN CYBSP_A6_PIN
#define CYBSP_POT_PIN CYBSP_A6_PIN
#define CYBSP_A6_NUM 6U
#define CYBSP_J2_13_NUM CYBSP_A6_NUM
#define CYBSP_POT_NUM CYBSP_A6_NUM
#define CYBSP_A6_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_J2_13_DRIVEMODE CYBSP_A6_DRIVEMODE
#define CYBSP_POT_DRIVEMODE CYBSP_A6_DRIVEMODE
#define CYBSP_A6_INIT_DRIVESTATE 1
#define CYBSP_J2_13_INIT_DRIVESTATE CYBSP_A6_INIT_DRIVESTATE
#define CYBSP_POT_INIT_DRIVESTATE CYBSP_A6_INIT_DRIVESTATE
#ifndef ioss_0_port_10_pin_6_HSIOM
    #define ioss_0_port_10_pin_6_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_A6_HSIOM ioss_0_port_10_pin_6_HSIOM
#define CYBSP_J2_13_HSIOM CYBSP_A6_HSIOM
#define CYBSP_POT_HSIOM CYBSP_A6_HSIOM
#define CYBSP_A6_IRQ ioss_interrupts_gpio_10_IRQn
#define CYBSP_J2_13_IRQ CYBSP_A6_IRQ
#define CYBSP_POT_IRQ CYBSP_A6_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_A6_HAL_PORT_PIN P10_6
    #define CYBSP_J2_13_HAL_PORT_PIN CYBSP_A6_HAL_PORT_PIN
    #define CYBSP_POT_HAL_PORT_PIN CYBSP_A6_HAL_PORT_PIN
    #define CYBSP_A6 P10_6
    #define CYBSP_J2_13 CYBSP_A6
    #define CYBSP_POT CYBSP_A6
    #define CYBSP_A6_HAL_IRQ CYHAL_GPIO_IRQ_NONE
    #define CYBSP_J2_13_HAL_IRQ CYBSP_A6_HAL_IRQ
    #define CYBSP_POT_HAL_IRQ CYBSP_A6_HAL_IRQ
    #define CYBSP_A6_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_J2_13_HAL_DIR CYBSP_A6_HAL_DIR
    #define CYBSP_POT_HAL_DIR CYBSP_A6_HAL_DIR
    #define CYBSP_A6_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_J2_13_HAL_DRIVEMODE CYBSP_A6_HAL_DRIVEMODE
    #define CYBSP_POT_HAL_DRIVEMODE CYBSP_A6_HAL_DRIVEMODE
...
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_A6_config;
#define CYBSP_J2_13_config CYBSP_A6_config
#define CYBSP_POT_config CYBSP_A6_config
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_A6_obj;
    #define CYBSP_J2_13_obj CYBSP_A6_obj
    #define CYBSP_POT_obj CYBSP_A6_obj
#endif //defined (CY_USING_HAL)
